...
<tileset version="1.2" tiledversion="1.3.4" name="watergrass" tilewidth="32" tileheight="32" tilecount="18" columns="3">
 <image source="../Assets/LPC Base Assets/tiles/watergrass.png" width="96" height="192"/>
 <terraintypes>
